...
async function getFaq(accessToken, id) {
...
export default async function GetFaqAPI(id) {
  var accessToken = getCookie("accessToken");
  var refreshToken = getCookie("refreshToken");

  if (accessToken) {
    try {
      let data = await getFaq(accessToken, id);
      ...
      if (refreshToken) {
        try {
          ...
          let data = await getFaq(newAccessToken, id);
          console.log(data.result);
