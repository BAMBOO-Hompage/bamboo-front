...
export default function AlexandriaData() {
  return [
    {
      libraryPostId: 20,
      paperName: "Zero-Shot Text-to-Image Generation hi my name",
      year: "2024",
      tagNames: ["transformer", "detector", "transformer", "detector"],
      topic: "T2I generation: DALL-E (feat.multi-modal)",
      speaker: {
        studentId: 1,
        name: "김희재",
      },
...
- 따라서 IMAGEBIND는 적은 훈련으로도 다양한 modality와 task에 적용할 수 있음`,
    ...
    {
      libraryPostId: 18,
      paperName: "Iero-Shot Text-to-Image Generation hi my name",
      year: "2025",
      tagNames: ["#transformer", "#detector"],
      topic: "T2I generation: DALL-E (feat.multi-modal)",
      speaker: {
...
### 3. Implementation Details`,
    ...
    {
      libraryPostId: 17,
      paperName: "Pero-Shot Text-to-Image Generation hi my name",
      year: "2023",
      tagNames: ["#transformer", "#detector"],
      topic: "T2I generation: DALL-E (feat.multi-modal)",
      speaker: {
    ...
    {
      libraryPostId: 16,
      paperName: "Lero-Shot Text-to-Image Generation hi my name",
      year: "2022",
      tagNames: ["#transformer", "#detector"],
      topic: "T2I generation: DALL-E (feat.multi-modal)",
      speaker: {
    ...
    {
      libraryPostId: 15,
      paperName: "Oero-Shot Text-to-Image Generation hi my name",
      year: "2020",
      tagNames: ["#transformer", "#detector"],
      topic: "T2I generation: DALL-E (feat.multi-modal)",
      speaker: {
