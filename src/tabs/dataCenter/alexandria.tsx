...
export default function Alexandria() {
    ...
    const filteredData = data.filter((paper) => paperList === '전체' || paper.category === paperList);
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option value="연도" style={{ background: '#111015', cursor: 'pointer' }}>
                                                연도
                                            </option>
                                            <option value="태그" style={{ background: '#111015', cursor: 'pointer' }}>
                                                태그
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <img src="../../img/btn/move.png" style={{ width: '13px' }} />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
